...
{	
	...
	std::vector<std::string> Name_list;
       ...
       {
         if(strstr(ptr->d_name, ".jpg")||strstr(ptr->d_name, ".png")||strstr(ptr->d_name,".jpeg"))
         {
	...
	{		
              ...
              cv::Mat data_image = cv::imread(argv[2]+Name_list[n],1);
	...
	{			
		...
		rank_list<<"<p><img src="<<argv[2]<<Name_list[matches[0][n].trainIdx]<<" width="<<image.cols*128/image.rows<<" height=128 /><br></p>"<<endl;
	}
	return 0;
}
